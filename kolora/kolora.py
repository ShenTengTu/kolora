...
_COLOR256 = _Color_Map()(
    ...
    SpringGreen4="#00875f",
    Turquoise4="#008787",
    DeepSkyBlue3_0="#0087af",
    DeepSkyBlue3_1="#0087d7",
    DodgerBlue1="#0087ff",
    Green3_0="#00af00",
    SpringGreen3_0="#00af5f",
    DarkCyan="#00af87",
    ...
    RoyalBlue1="#5f5fff",
    Chartreuse4="#5f8700",
    DarkSeaGreen4_0="#5f875f",
    PaleTurquoise4="#5f8787",
    SteelBlue="#5f87af",
    SteelBlue3="#5f87d7",
    CornflowerBlue="#5f87ff",
    Chartreuse3_0="#5faf00",
    ...
    SteelBlue1_1="#5fd7ff",
    Chartreuse2_0="#5fff00",
    SeaGreen2="#5fff5f",
    SeaGreen1_0="#5fff87",
    SeaGreen1_1="#5fffaf",
    Aquamarine1_0="#5fffd7",
    DarkSlateGray2="#5fffff",
    DarkRed_1="#870000",
    DeepPink4_1="#87005f",
    DarkMagenta_0="#870087",
    ...
    Yellow4_1="#87af00",
    DarkOliveGreen3_0="#87af5f",
    DarkSeaGreen="#87af87",
    LightSkyBlue3_0="#87afaf",
    LightSkyBlue3_1="#87afd7",
    SkyBlue2="#87afff",
    Chartreuse2_1="#87d700",
    DarkOliveGreen3_1="#87d75f",
    PaleGreen3_1="#87d787",
    DarkSeaGreen3_0="#87d7af",
    ...
    DarkViolet_1="#af00d7",
    Purple_2="#af00ff",
    DarkOrange3_0="#af5f00",
    IndianRed_0="#af5f5f",
    HotPink3_0="#af5f87",
    MediumOrchid3="#af5faf",
    MediumOrchid="#af5fd7",
    MediumPurple2_0="#af5fff",
    DarkGoldenrod="#af8700",
    LightSalmon3_0="#af875f",
    RosyBrown="#af8787",
    Grey63="#af87af",
    ...
    Plum1="#ffafff",
    Gold1="#ffd700",
    LightGoldenrod2_0="#ffd75f",
    LightGoldenrod2_1="#ffd787",
    NavajoWhite1="#ffd7af",
    MistyRose1="#ffd7d7",
    Thistle1="#ffd7ff",
    Yellow1="#ffff00",
...
def color_256_xtrem(s):
    ...
    if not is_hex_color_code(s):
        ...
        if item is None:  # try to get the nearst in 256 color map
            ...
            diff = (
                lambda rgb1, rgb2: (rgb2[0] - rgb1[0]) ** 2
                + (rgb2[1] - rgb1[1]) ** 2
                + (rgb2[2] - rgb1[2]) ** 2
            )
            rgb_in = hex_to_rgb(s)
...
class Kolora:
    ...
    __color_deep = {"8": 5, "24": 2}
    __color_side = {"fg": 38, "bg": 48}
